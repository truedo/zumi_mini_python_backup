...
class CommandType(Enum):
    ...
    COMMAND_LINE_TRACE_TIME                 = 36
    COMMAND_GOSENSOR_SET                    = 37
    COMMAND_LINE_TRACING_SET                = 38
    ...
    COMMAND_TEST_MOVE1                      = 204

    COMMAND_COLOR_TRACKING2                 = 211
    COMMAND_COLOR_TRACKING3                 = 212

    COMMAND_MOVE_SLOW_L                     = 230
    COMMAND_MOVE_SLOW_R                     = 231
    COMMAND_MOVE_SLOW_ALL                   = 232
