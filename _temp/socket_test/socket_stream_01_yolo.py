...
class YOLODetector:
    def __init__(self, model_name="yolov5s", confidence=0.25):
        ...
        try:
            ...
            self.model.imgsz = 320  # 입력 이미지 크기 설정
...
class WebSocketCameraClient:
    def __init__(self, url, use_yolo=True, model_name="yolov5s", confidence=0.25):
        self.url = url
        self.ws = None
    ...
    def on_message(self, ws, message):
        ...
        try:
            ...
            print(f"Loaded image shape: {img.shape}")  # (240, 320, 3) 출력 확인
            #img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)  # YOLO는 RGB 입력 필요
